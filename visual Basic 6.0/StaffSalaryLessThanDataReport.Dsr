VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} StaffSalaryLessThanDataReport 
   Bindings        =   "StaffSalaryLessThanDataReport.dsx":0000
   Caption         =   "StaffSalaryLessThan"
   ClientHeight    =   7665
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   13065
   ...
   TopMargin       =   12
   BottomMargin    =   12
   DataMember      =   "StaffonSalaryLessThan"
   NumSections     =   5
   SectionCode0    =   1
   ...
   EndProperty
End
Attribute VB_Name = "StaffSalaryLessThanDataReport"
